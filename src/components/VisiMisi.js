    ...
    <div>
      ...
      <Container>
        <Row className='jarak-section1'>
          <Col>
            <div>
              ...
              <h1 style={{ fontSize: '52px' }}>KONSERVASI INDONESIA</h1>
            </div>
          </Col>
        </Row>
        <Row className="mb-4" style={{backgroundColor: '#eaf9ff'}}>
          <Col md={6}>
            <div>
              <h1 className='judul-section' style={{ fontSize: '52px', fontWeight: 'normal'}}>VISI</h1>
          ...
          <Col md={6} style={{ padding: '0' }}>
            <Image src={visi} className="img-fluid" alt="Visi" />
          </Col>
        </Row>

        <Row className="mb-4" style={{backgroundColor: '#eaf9ff'}}>
          <Col md={6} style={{ padding: '0' }}>
            <Image src={misi} className="img-fluid" alt="Misi" />
          </Col>
          <Col md={6} className="visiMisi">
            <div>
              <h1 className='judul-section' style={{ fontSize: '52px', fontWeight: 'normal'}}>MISI</h1>
              <p style={{ fontSize: '20px' }}>
        ...
        <div className="py-5">
          <Row>
            <Col>
              <h2 className='judul-section' style={{ fontSize: '42px' }}>KEMITRAAN STRATEGIS KAMI</h2>
              <p style={{ fontSize: '20px' }}>
